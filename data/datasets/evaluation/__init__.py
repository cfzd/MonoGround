...
def evaluate_python(label_path, result_path, label_split_file, current_class, metric, nuscenes_category = False):
    result, ret_dict = _evaluate_python(label_path, result_path, label_split_file, current_class, metric=metric, nuscenes_category=nuscenes_category)
