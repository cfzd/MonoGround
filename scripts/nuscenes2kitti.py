...
class KittiConverter:
    def __init__(self,
                 nusc_kitti_dir: str = '/path/to/your/nuscenes',
        ...
        self.nusc = NuScenes(version=nusc_version, dataroot = '/home/zequn/dataset/nuscenes')
    ...
    def nuscenes_gt_to_kitti(self) -> None:
        ...
        tokens = []
        for sampel_idx, sample_token in enumerate(sample_tokens):
            ...
            if os.path.exists(label_path):
                ...
                print(' %.3f | Writing file: %s' % (sampel_idx/len(sample_tokens) ,label_path))
    ...
    def render_kitti(self, render_2d: bool) -> None:
        ...
        kitti = KittiDB(root=self.nusc_kitti_dir, splits=('trainval',))
