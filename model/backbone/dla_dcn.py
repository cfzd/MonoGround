...
def build_backbone(cfg):
    ...
    model = DLASeg(base_name=cfg.MODEL.BACKBONE.CONV_BODY,
                ...
                last_level=5,
                freeze = cfg.MODEL.HEAD.FREEZE_BACKBONE and cfg.MODEL.HEAD.ADD_GROUND_DEPTH
            )
    
    return model

class DLASeg(nn.Module):
    def __init__(self, base_name, pretrained, down_ratio, last_level, freeze = False):
